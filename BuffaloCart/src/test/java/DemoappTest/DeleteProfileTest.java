...
public class DeleteProfileTest extends LoginTest {
	...
	@Test
	public void deleteProfile(String a,String b) throws IOException
	{
		...
		ob.getExcelData("C:\\Users\\danniyax\\Documents\\DeleteProfile.xlsx", 1);
		deleteUser.deleteUserProfile(a);
	}
